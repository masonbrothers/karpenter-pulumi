...
export namespace karpenter {
    export namespace v1 {
        ...
        /**
         * ec2nodeClassSpecProvideDefaults sets the appropriate defaults for EC2NodeClassSpec
         */
        export function ec2nodeClassSpecProvideDefaults(val: EC2NodeClassSpec): EC2NodeClassSpec {
            return {
                ...val,
                metadataOptions: (val.metadataOptions ? outputs.karpenter.v1.ec2nodeClassSpecMetadataOptionsProvideDefaults(val.metadataOptions) : undefined),
            };
        }
        ...
        /**
         * ec2nodeClassSpecMetadataOptionsProvideDefaults sets the appropriate defaults for EC2NodeClassSpecMetadataOptions
         */
        export function ec2nodeClassSpecMetadataOptionsProvideDefaults(val: EC2NodeClassSpecMetadataOptions): EC2NodeClassSpecMetadataOptions {
            return {
                ...val,
        ...
        /**
         * ec2nodeClassStatusCapacityReservationsProvideDefaults sets the appropriate defaults for EC2NodeClassStatusCapacityReservations
         */
        export function ec2nodeClassStatusCapacityReservationsProvideDefaults(val: EC2NodeClassStatusCapacityReservations): EC2NodeClassStatusCapacityReservations {
            return {
                ...val,
        ...
        /**
         * nodeClaimSpecProvideDefaults sets the appropriate defaults for NodeClaimSpec
         */
        export function nodeClaimSpecProvideDefaults(val: NodeClaimSpec): NodeClaimSpec {
            return {
                ...val,
        ...
        /**
         * nodePoolSpecProvideDefaults sets the appropriate defaults for NodePoolSpec
         */
        export function nodePoolSpecProvideDefaults(val: NodePoolSpec): NodePoolSpec {
            return {
                ...val,
                disruption: (val.disruption ? outputs.karpenter.v1.nodePoolSpecDisruptionProvideDefaults(val.disruption) : undefined),
                template: outputs.karpenter.v1.nodePoolSpecTemplateProvideDefaults(val.template),
            };
        }
        ...
        /**
         * nodePoolSpecDisruptionProvideDefaults sets the appropriate defaults for NodePoolSpecDisruption
         */
        export function nodePoolSpecDisruptionProvideDefaults(val: NodePoolSpecDisruption): NodePoolSpecDisruption {
            return {
                ...val,
        ...
        /**
         * nodePoolSpecDisruptionBudgetsProvideDefaults sets the appropriate defaults for NodePoolSpecDisruptionBudgets
         */
        export function nodePoolSpecDisruptionBudgetsProvideDefaults(val: NodePoolSpecDisruptionBudgets): NodePoolSpecDisruptionBudgets {
            return {
                ...val,
                nodes: (val.nodes) ?? "10%",
            };
        ...
        /**
         * nodePoolSpecTemplateProvideDefaults sets the appropriate defaults for NodePoolSpecTemplate
         */
        export function nodePoolSpecTemplateProvideDefaults(val: NodePoolSpecTemplate): NodePoolSpecTemplate {
            return {
                ...val,
                spec: outputs.karpenter.v1.nodePoolSpecTemplateSpecProvideDefaults(val.spec),
            };
        }
        ...
        /**
         * nodePoolSpecTemplateSpecProvideDefaults sets the appropriate defaults for NodePoolSpecTemplateSpec
         */
        export function nodePoolSpecTemplateSpecProvideDefaults(val: NodePoolSpecTemplateSpec): NodePoolSpecTemplateSpec {
            return {
                ...val,
                expireAfter: (val.expireAfter) ?? "720h",
            };
        ...
        /**
         * nodePoolStatusProvideDefaults sets the appropriate defaults for NodePoolStatus
         */
        export function nodePoolStatusProvideDefaults(val: NodePoolStatus): NodePoolStatus {
            return {
                ...val,
                nodes: (val.nodes) ?? 0,
            };
